...
function get_hansel_and_gretel_breadcrumbs()
{
    ...
    $delimider_image = get_field('pages_delimiter', 'options');  // Delimiter between crumbs
    $delimiter_url = $delimider_image['url'];
    $delimiter_alt = $delimider_image['alt'];
    $delimiter_title = $delimider_image['title'];

    $delimiter        = '<img src=' . $delimiter_url . ' alt=' . $delimiter_alt . ' title=' . $delimiter_title . '>';
